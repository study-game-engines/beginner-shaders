*Read wiki on [how to configure builds for Windows users](https://github.com/study-game-engines/beginner-shaders/wiki/How-to-configure-builds-for-Windows-users)* 
